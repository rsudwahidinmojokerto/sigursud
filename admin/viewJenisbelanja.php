<?php 
    ...
    if (isset($_GET['delete'])) {
        $response = $qb->delete("table_barang","kd_barang",$_GET['id'],"?page=viewJenisbelanja");
    }
 ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="?page=addJenisBelanja" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Barang</a>
                           </button>
                           <br>
                           <br>
