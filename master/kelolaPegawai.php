<?php 
    ...
    $rg = new lsp();
    $table = "tm_user";
    $autokode = $rg->autokode($table, "id_user", "US");
    ...
    if(isset($_GET['delete'])){
        $response = $rg->delete($table,"id_user",$_GET['id'],"?page=kelolaPegawai");
    }
                                       ...
                                       <script>
                                        $('#btnDelete<?php echo $no; ?>').click(function(e){
                                                      e.preventDefault();
                                                        ...
                                                        if (isConfirm) {
                                                            window.location.href="?page=kelolaPegawai&delete&id=<?php echo $dataB['id_user'] ?>";
                                                        }
                                                      });
                                                    });
                                        </script>
