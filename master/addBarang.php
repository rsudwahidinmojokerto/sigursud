                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card-body">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control" name="kode_barang" value="<?php echo $autokodeBarangBhp; ?>" readonly>
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_barang" class="form-control">
                                        <option value=" ">Pilih Jenis Barang</option>
                                        <?php foreach($getJenisbarang as $mr) { ?>
                                        <option value="<?= $mr['id_kategori_bhp'] ?>"><?= $mr['nama_kategori_bhp'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
